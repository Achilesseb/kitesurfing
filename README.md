...
```
cd existing_repo
git remote add origin https://gitlab.com/Achilesseb/kitesurfing.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Achilesseb/kitesurfing/-/settings/integrations)
